...
class _$PersonTearOff {
  ...
  _Person call(String name, int age, double cgpa) {
    return _Person(
      name,
      age,
      cgpa,
...
abstract class $PersonCopyWith<$Res> {
  ...
  $Res call({String name, int age, double cgpa});
}
...
class _$_Person implements _Person {
  const _$_Person(this.name, this.age, this.cgpa);
  ...
  @override
  String toString() {
    return 'Person(name: $name, age: $age, cgpa: $cgpa)';
  }
...
abstract class _Person implements Person {
  const factory _Person(String name, int age, double cgpa) = _$_Person;
